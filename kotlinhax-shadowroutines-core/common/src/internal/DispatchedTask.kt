...
internal abstract class DispatchedTask<in T> internal constructor(
    ...
    /**
     * Machinery that handles fatal exceptions in kotlinhax.shadowroutines.
     * There are two kinds of fatal exceptions:
     *
     * 1) Exceptions from kotlinhax.shadowroutines code. Such exceptions indicate that either
