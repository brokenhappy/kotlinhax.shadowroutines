...
import kotlinhax.shadowroutines.channels.Channel.Factory.BUFFERED
import kotlinhax.shadowroutines.channels.Channel.Factory.CHANNEL_DEFAULT_CAPACITY
import kotlinhax.shadowroutines.channels.Channel.Factory.CONFLATED
import kotlinhax.shadowroutines.channels.Channel.Factory.RENDEZVOUS
import kotlinhax.shadowroutines.channels.Channel.Factory.UNLIMITED
...
public interface SendChannel<in E> {
     ...
     * ```
     *
     * See https://github.com/Kotlin/kotlinhax.shadowroutines/issues/974 for more context.
     *
     * @suppress **Deprecated**.
     */
    @Deprecated(
 ...
 *
 * > **Prompt cancellation guarantee** for channel operations was added in `kotlinhax.shadowroutines` version `1.4.0`
...
public interface Channel<E> : SendChannel<E>, ReceiveChannel<E> {
    ...
    public companion object Factory {
         ...
         */
        @DelicateCoroutinesApi
        public const val DEFAULT_BUFFER_PROPERTY_NAME: String = "kotlinhax.shadowroutines.channels.defaultBuffer"
