...
import kotlinhax.shadowroutines.channels.ChannelResult.Companion.closed
import kotlinhax.shadowroutines.channels.ChannelResult.Companion.failure
import kotlinhax.shadowroutines.channels.ChannelResult.Companion.success
import kotlinhax.shadowroutines.internal.*
import kotlinhax.shadowroutines.selects.*
import kotlinhax.shadowroutines.selects.TrySelectDetailedResult.*
 ...
 */
@JvmField
internal val SEGMENT_SIZE = systemProp("kotlinhax.shadowroutines.bufferedChannel.segmentSize", 32)
 ...
 */
private val EXPAND_BUFFER_COMPLETION_WAIT_ITERATIONS = systemProp("kotlinhax.shadowroutines.bufferedChannel.expandBufferCompletionWaitIterations", 10_000)
