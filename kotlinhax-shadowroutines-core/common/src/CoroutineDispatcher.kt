 ...
 *
 * If `kotlinhax-shadowroutines` is used, it is recommended to avoid [ContinuationInterceptor] instances that are not
 ...
 *
 * The following standard implementations are provided by `kotlinhax.shadowroutines` as properties on
