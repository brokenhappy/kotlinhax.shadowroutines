...
public interface CancellableContinuation<in T> : Continuation<T> {
     ...
     * It's illegal to call this function in any non-`kotlinhax.shadowroutines` code and
 ...
 * For multi-shot callback APIs see [callbackFlow][kotlinhax.shadowroutines.flow.callbackFlow].
 *
 * ```
