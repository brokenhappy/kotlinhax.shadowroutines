...
private val MAX_SPIN_CYCLES = systemProp("kotlinhax.shadowroutines.semaphore.maxSpinCycles", 100)
private val PERMIT = Symbol("PERMIT")
private val TAKEN = Symbol("TAKEN")
private val BROKEN = Symbol("BROKEN")
private val CANCELLED = Symbol("CANCELLED")
private val SEGMENT_SIZE = systemProp("kotlinhax.shadowroutines.semaphore.segmentSize", 16)
