 ...
 *   potentially concurrent calls to the [send][kotlinhax.shadowroutines.channels.SendChannel.send] function.
 ...
 * reactive streams using [Flow.asPublisher] and [Publisher.asFlow] from `kotlinhax-shadowroutines-reactive` module.
 *
