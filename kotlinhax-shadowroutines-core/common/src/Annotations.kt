...
@RequiresOptIn(
    ...
    message = "This declaration is in a preview state and can be changed in a backwards-incompatible manner with a best-effort migration. " +
            "Its usage should be marked with '@kotlinhax.shadowroutines.FlowPreview' or '@OptIn(kotlinhax.shadowroutines.FlowPreview::class)' " +
 ...
 * `kotlinhax.shadowroutines`, because their signatures and semantics will change between future releases without any
...
@Target(AnnotationTarget.CLASS, AnnotationTarget.FUNCTION, AnnotationTarget.TYPEALIAS, AnnotationTarget.PROPERTY)
@RequiresOptIn(
    level = RequiresOptIn.Level.ERROR, message = "This is an internal kotlinhax.shadowroutines API that " +
            "should not be used from outside of kotlinhax.shadowroutines. No compatibility guarantees are provided. " +
            "It is recommended to report your use-case of internal API to kotlinhax.shadowroutines issue tracker, " +
...
@RequiresOptIn(
    ...
    "Inheriting from this kotlinhax.shadowroutines API is unstable. " +
...
@RequiresOptIn(
    level = RequiresOptIn.Level.WARNING, message =
    "This is a kotlinhax.shadowroutines API that is not intended to be inherited from, " +
        ...
        "https://github.com/Kotlin/kotlinhax.shadowroutines/issues, so that we can provide a stable API for inheritance. "
)
