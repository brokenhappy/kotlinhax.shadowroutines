...
public expect object Dispatchers {
     ...
     * - `Dispatchers.setMain` from the `kotlinhax-shadowroutines-test` artifact can replace the main dispatcher with a mock one for testing.
     *
     ...
     *  - `kotlinhax-shadowroutines-android` &mdash; for Android Main thread dispatcher
     *  - `kotlinhax-shadowroutines-javafx` &mdash; for JavaFx Application thread dispatcher
     *  - `kotlinhax-shadowroutines-swing` &mdash; for Swing EDT dispatcher
     */
