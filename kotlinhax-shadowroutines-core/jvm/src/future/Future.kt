...
import kotlinhax.shadowroutines.CancellationException
 ...
 * stops waiting for the completion stage and immediately resumes with [CancellationException][kotlinhax.shadowroutines.CancellationException].
 *
...
private class CancelFutureOnCompletion(
    ...
    override fun invoke(cause: Throwable?) {
        ...
        // on reentrancy. See https://github.com/Kotlin/kotlinhax.shadowroutines/issues/4156
