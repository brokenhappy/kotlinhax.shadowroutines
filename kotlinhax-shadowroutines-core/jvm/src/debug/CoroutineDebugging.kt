 ...
 * [stacktrace recovery](https://github.com/Kotlin/kotlinhax.shadowroutines/blob/master/docs/topics/debugging.md#stacktrace-recovery)
 * documentation. The usual way to enable the debug mode is with the [kotlinhax.shadowroutines.DEBUG_PROPERTY_NAME] system
 * property.
 * 2. By looking at the output of DebugProbes; see the
 * [kotlinhax-shadowroutines-debug](https://github.com/Kotlin/kotlinhax.shadowroutines/tree/master/kotlinhax-shadowroutines-debug) module.
 */
internal class ArtificialStackFrames {
     ...
     *
     * In earlier versions of kotlinhax-shadowroutines, this was displayed as "(Coroutine creation stacktrace)", which caused
     * problems for tooling that processes stack traces: https://github.com/Kotlin/kotlinhax.shadowroutines/issues/2291
     *
     ...
     * of another begins.
     *
     * In earlier versions of kotlinhax-shadowroutines, this was displayed as "(Coroutine boundary)", which caused
     * problems for tooling that processes stack traces: https://github.com/Kotlin/kotlinhax.shadowroutines/issues/2291
     */
