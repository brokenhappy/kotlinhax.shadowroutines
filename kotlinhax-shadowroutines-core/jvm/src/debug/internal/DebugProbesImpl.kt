...
import kotlinhax.shadowroutines.internal.ScopeCoroutine
import java.io.*
...
internal object DebugProbesImpl {
    ...
    private fun getDynamicAttach(): Function1<Boolean, Unit>? = runCatching {
        val clz = Class.forName("kotlinhax.shadowroutines.debug.ByteBuddyDynamicAttach")
    ...
    private val StackTraceElement.isInternalMethod: Boolean get() = className.startsWith("kotlinhax.shadowroutines")
}
