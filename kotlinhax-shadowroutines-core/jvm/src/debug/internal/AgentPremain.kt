...
/*
 * This class is loaded if and only if kotlinhax-shadowroutines-core was used as -javaagent argument,
...
internal object AgentPremain {
    ...
    private val enableCreationStackTraces = runCatching {
        System.getProperty("kotlinhax.shadowroutines.debug.enable.creation.stack.trace")?.toBoolean()
    ...
    internal object DebugProbesTransformer : ClassFileTransformer {
        override fun transform(
             ...
             * kotlinhax.shadowroutines.debug.DebugProbesImpl. This is done to avoid classfile patching
