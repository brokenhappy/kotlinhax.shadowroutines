 ...
 */
public const val IO_PARALLELISM_PROPERTY_NAME: String = "kotlinhax.shadowroutines.io.parallelism"
...
public actual object Dispatchers {
    ...
    @JvmStatic
    public actual val Unconfined: CoroutineDispatcher = kotlinhax.shadowroutines.Unconfined
     ...
     * "`kotlinhax.shadowroutines.io.parallelism`" ([IO_PARALLELISM_PROPERTY_NAME]) system property.
     ...
     * framework in order to make kotlinhax.shadowroutines classes unloadable by Java Virtual Machine.
