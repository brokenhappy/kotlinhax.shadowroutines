package kotlinhax.shadowroutines.scheduling
...
internal val DEFAULT_SCHEDULER_NAME = systemProp(
    "kotlinhax.shadowroutines.scheduler.default.name", "DefaultDispatcher"
)

// 100us as default
@JvmField
internal val WORK_STEALING_TIME_RESOLUTION_NS = systemProp(
    "kotlinhax.shadowroutines.scheduler.resolution.ns", 100000L
)
...
internal val CORE_POOL_SIZE = systemProp(
    "kotlinhax.shadowroutines.scheduler.core.pool.size",
...
internal val MAX_POOL_SIZE = systemProp(
    "kotlinhax.shadowroutines.scheduler.max.pool.size",
...
internal val IDLE_WORKER_KEEP_ALIVE_NS = TimeUnit.SECONDS.toNanos(
    systemProp("kotlinhax.shadowroutines.scheduler.keep.alive.sec", 60L)
)
