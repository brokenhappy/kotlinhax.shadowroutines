...
internal object FastServiceLoader {
     ...
     *    While it is not the problem of `kotlinhax.shadowroutines`, it significantly worsens user experience, thus we are workarounding it.
    ...
    internal fun loadMainDispatcherFactory(): List<MainDispatcherFactory> {
        ...
        return try {
            ...
            val mainFactory = createInstanceOf(clz, "kotlinhax.shadowroutines.android.AndroidDispatcherFactory")
            if (mainFactory == null) {
            ...
            createInstanceOf(clz, "kotlinhax.shadowroutines.test.internal.TestMainDispatcherFactory")?.apply { result.add(this) }
            result
        } catch (_: Throwable) {
