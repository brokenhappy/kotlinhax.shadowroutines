 ...
 */
private const val FAST_SERVICE_LOADER_PROPERTY_NAME = "kotlinhax.shadowroutines.fast.service.loader"
...
internal fun throwMissingMainDispatcherException(): Nothing {
    throw IllegalStateException(
        "Module with the Main dispatcher is missing. " +
            "Add dependency providing the Main dispatcher, e.g. 'kotlinhax-shadowroutines-android' " +
            "and ensure it has the same version as 'kotlinhax-shadowroutines-core'"
    )
}
