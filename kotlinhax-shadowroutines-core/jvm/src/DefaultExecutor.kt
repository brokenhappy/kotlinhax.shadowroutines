...
private val defaultMainDelayOptIn = systemProp("kotlinhax.shadowroutines.main.delay", false)
...
internal actual object DefaultExecutor : EventLoopImplBase(), Runnable {
    const val THREAD_NAME = "kotlinhax.shadowroutines.DefaultExecutor"
    ...
    private val KEEP_ALIVE_NANOS = TimeUnit.MILLISECONDS.toNanos(
        try {
            java.lang.Long.getLong("kotlinhax.shadowroutines.DefaultExecutor.keepAlive", DEFAULT_KEEP_ALIVE_MS)
