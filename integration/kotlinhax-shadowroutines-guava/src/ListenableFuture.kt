package kotlinhax.shadowroutines.guava
 ...
 * completes with [kotlinhax.shadowroutines.CancellationException] - `this` `Deferred` will synchronously
 ...
 * stops waiting for the future and immediately resumes with [CancellationException][kotlinhax.shadowroutines.CancellationException].
 *
 ...
 * [kotlinhax.shadowroutines.NonCancellable].
 */
