...
// This is required for BlockHound tests to work, see https://github.com/Kotlin/kotlinhax.shadowroutines/issues/3701
    ...
    reports {
        filters {
            excludes {
                ...
                classes("kotlinhax.shadowroutines.debug.NoOpProbesKt")
            }
        }
    }
}
