    ...
    fun testStackMergeWithContext() = runTest {
        ...
        verifyDump(
            "Coroutine \"coroutine#2\":StandaloneCoroutine{Active}@50284dc4, state: RUNNING\n" +
                ...
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest.nonSuspendingFun(RunningThreadStackMergeTest.kt:86)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest.access\$nonSuspendingFun(RunningThreadStackMergeTest.kt:12)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest\$suspendingFunction\$2.invokeSuspend(RunningThreadStackMergeTest.kt:77)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest.suspendingFunction(RunningThreadStackMergeTest.kt:75)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest\$launchCoroutine\$1.invokeSuspend(RunningThreadStackMergeTest.kt:68)",
    ...
    fun testStackMergeEscapeSuspendMethod() = runTest {
        ...
        verifyDump(
            "Coroutine \"coroutine#2\":StandaloneCoroutine{Active}@3aea3c67, state: RUNNING\n" +
                ...
                "\tat java.util.concurrent.CyclicBarrier.dowait(CyclicBarrier.java:234)\n" +
                "\tat java.util.concurrent.CyclicBarrier.await(CyclicBarrier.java:362)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest.nonSuspendingFun(RunningThreadStackMergeTest.kt:83)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest.access\$nonSuspendingFun(RunningThreadStackMergeTest.kt:12)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest\$suspendingFunctionWithContext\$2.invokeSuspend(RunningThreadStackMergeTest.kt:124)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest.suspendingFunctionWithContext(RunningThreadStackMergeTest.kt:122)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest\$launchEscapingCoroutine\$1.invokeSuspend(RunningThreadStackMergeTest.kt:116)",
            ignoredCoroutine = "BlockingCoroutine"
        ) {
            coroutineBlocker.await()
        }
    ...
    fun testMergeThroughInvokeSuspend() = runTest {
        ...
        verifyDump(
            "Coroutine \"coroutine#2\":StandaloneCoroutine{Active}@3aea3c67, state: RUNNING\n" +
                ...
                "\tat java.util.concurrent.CyclicBarrier.await(CyclicBarrier.java:362)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest.nonSuspendingFun(RunningThreadStackMergeTest.kt:83)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest.suspendingFunctionWithoutContext(RunningThreadStackMergeTest.kt:160)\n" +
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest\$launchEscapingCoroutineWithoutContext\$1.invokeSuspend(RunningThreadStackMergeTest.kt:153)",
            ignoredCoroutine = "BlockingCoroutine"
        ) {
            coroutineBlocker.await()
        }
    ...
    fun testRunBlocking() = runBlocking {
        verifyDump(
            "Coroutine \"coroutine#1\":BlockingCoroutine{Active}@4bcd176c, state: RUNNING\n" +
                ...
                "\tat kotlinhax.shadowroutines.debug.DebugProbes.dumpCoroutines(DebugProbes.kt)\n" +
                ...
                "\tat kotlinhax.shadowroutines.debug.RunningThreadStackMergeTest\$testRunBlocking\$1.invokeSuspend(RunningThreadStackMergeTest.kt)"
        )
    }
