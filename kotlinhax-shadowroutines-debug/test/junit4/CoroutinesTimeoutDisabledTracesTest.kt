    ...
    public val validation = TestFailureValidation(
        ...
        TestResultSpec(
            "hangingTest", expectedOutParts = listOf(
                ...
                "at kotlinhax.shadowroutines.debug.junit4.CoroutinesTimeoutDisabledTracesTest.hangForever",
                "at kotlinhax.shadowroutines.debug.junit4.CoroutinesTimeoutDisabledTracesTest.waitForHangJob"
            ),
