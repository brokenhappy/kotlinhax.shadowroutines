    ...
    public val validation = TestFailureValidation(
        ...
        TestResultSpec(
            "hangingTest", expectedOutParts = listOf(
                ...
                "runBlocking",
                "at kotlinhax.shadowroutines.debug.junit4.CoroutinesTimeoutTest.suspendForever",
                "at kotlinhax.shadowroutines.debug.junit4.CoroutinesTimeoutTest\$hangingTest\$1.invokeSuspend"),
