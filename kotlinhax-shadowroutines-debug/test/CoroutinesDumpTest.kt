...
class CoroutinesDumpTest : DebugTestBase() {
    ...
    fun testSuspendedCoroutine() = runBlocking {
        ...
        verifyDump(
            "Coroutine \"coroutine#1\":DeferredCoroutine{Active}@1e4a7dd4, state: SUSPENDED\n" +
                    "\tat kotlinhax.shadowroutines.debug.CoroutinesDumpTest.sleepingNestedMethod(CoroutinesDumpTest.kt)\n" +
                    "\tat kotlinhax.shadowroutines.debug.CoroutinesDumpTest.sleepingOuterMethod(CoroutinesDumpTest.kt)\n" +
                    ...
                    "\tat kotlinhax.shadowroutines.intrinsics.CancellableKt.startCoroutineCancellable(Cancellable.kt)\n" +
                    "\tat kotlinhax.shadowroutines.CoroutineStart.invoke(CoroutineStart.kt)\n",
    ...
    fun testRunningCoroutine() = runBlocking {
        ...
        verifyDump(
            "Coroutine \"coroutine#1\":DeferredCoroutine{Active}@227d9994, state: RUNNING\n" +
                    ...
                    "\tat kotlinhax.shadowroutines.debug.CoroutinesDumpTest.nestedActiveMethod(CoroutinesDumpTest.kt)\n" +
                    "\tat kotlinhax.shadowroutines.debug.CoroutinesDumpTest.activeMethod(CoroutinesDumpTest.kt)\n" +
                    "\tat kotlinhax.shadowroutines.debug.CoroutinesDumpTest.access\$activeMethod(CoroutinesDumpTest.kt)\n" +
                    "\tat kotlinhax.shadowroutines.debug.CoroutinesDumpTest\$testRunningCoroutine\$1\$deferred\$1.invokeSuspend(CoroutinesDumpTest.kt)\n" +
                    "\tat _COROUTINE._CREATION._(CoroutineDebugging.kt)\n" +
                    "\tat kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted(IntrinsicsJvm.kt)\n" +
                    "\tat kotlinhax.shadowroutines.intrinsics.CancellableKt.startCoroutineCancellable(Cancellable.kt)\n" +
                    "\tat kotlinhax.shadowroutines.CoroutineStart.invoke(CoroutineStart.kt)\n" +
                    "\tat kotlinhax.shadowroutines.AbstractCoroutine.start(AbstractCoroutine.kt)\n" +
                    "\tat kotlinhax.shadowroutines.BuildersKt__Builders_commonKt.async(Builders.common.kt)\n" +
                    "\tat kotlinhax.shadowroutines.BuildersKt.async(Unknown Source)\n" +
                    ...
                    "\tat kotlinhax.shadowroutines.debug.CoroutinesDumpTest\$testRunningCoroutine\$1.invokeSuspend(CoroutinesDumpTest.kt)",
            ignoredCoroutine = "BlockingCoroutine"
        ) {
            deferred.cancel()
            coroutineThread?.interrupt()
    ...
    fun testRunningCoroutineWithSuspensionPoint() = runBlocking {
        ...
        verifyDump(
            "Coroutine \"coroutine#1\":DeferredCoroutine{Active}@1e4a7dd4, state: RUNNING\n" +
                    ...
                    "\tat kotlinhax.shadowroutines.BuildersKt__Builders_commonKt.async\$default(Builders.common.kt)\n" +
                    "\tat kotlinhax.shadowroutines.BuildersKt.async\$default(Unknown Source)\n" +
                    "\tat kotlinhax.shadowroutines.debug.CoroutinesDumpTest\$testRunningCoroutineWithSuspensionPoint\$1.invokeSuspend(CoroutinesDumpTest.kt)",
            ignoredCoroutine = "BlockingCoroutine"
        ) {
            deferred.cancel()
            coroutineThread!!.interrupt()
    ...
    fun testCreationStackTrace() = runBlocking {
        ...
        val expected =
            ...
            "kotlinhax.shadowroutines.intrinsics.CancellableKt.startCoroutineCancellable(Cancellable.kt)\n" +
            "kotlinhax.shadowroutines.CoroutineStart.invoke(CoroutineStart.kt)\n" +
            "kotlinhax.shadowroutines.AbstractCoroutine.start(AbstractCoroutine.kt)\n" +
            "kotlinhax.shadowroutines.BuildersKt__Builders_commonKt.async(Builders.common.kt)\n" +
            "kotlinhax.shadowroutines.BuildersKt.async(Unknown Source)\n" +
            "kotlinhax.shadowroutines.BuildersKt__Builders_commonKt.async\$default(Builders.common.kt)\n" +
            "kotlinhax.shadowroutines.BuildersKt.async\$default(Unknown Source)\n" +
            "kotlinhax.shadowroutines.debug.CoroutinesDumpTest\$testCreationStackTrace\$1.invokeSuspend(CoroutinesDumpTest.kt)"
