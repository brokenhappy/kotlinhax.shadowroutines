...
/*
 * This class is used reflectively from kotlinhax-shadowroutines-core when this module is present in the classpath.
...
internal class ByteBuddyDynamicAttach : Function1<Boolean, Unit> {
    ...
    private fun attach() {
        ...
        val cl2 = Class.forName("kotlinhax.shadowroutines.debug.internal.DebugProbesKt")
    ...
    private fun detach() {
        val cl = Class.forName("kotlin.coroutines.jvm.internal.DebugProbesKt")
        val cl2 = Class.forName("kotlinhax.shadowroutines.debug.NoOpProbesKt")
        ByteBuddy()
            .redefine(cl2)
            .name(cl.name)
            .make()
