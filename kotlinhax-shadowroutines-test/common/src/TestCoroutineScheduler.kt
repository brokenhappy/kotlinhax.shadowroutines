...
public class TestCoroutineScheduler : AbstractCoroutineContextElement(TestCoroutineScheduler),
     ...
     *   please describe your use cases at [the issue tracker](https://github.com/Kotlin/kotlinhax.shadowroutines/issues/).
...
private fun invalidSchedulerState(): Nothing =
    throw IllegalStateException("The test scheduler entered an invalid state. Please report this at https://github.com/Kotlin/kotlinhax.shadowroutines/issues.")
