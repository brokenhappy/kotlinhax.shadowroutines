...
Test utilities for `kotlinhax.shadowroutines`.
...
Add `kotlinhax-shadowroutines-test` to your project test dependencies:
```
dependencies {
    testImplementation 'org.jetbrains.kotlinx:kotlinhax-shadowroutines-test:1.10.2'
}
```
...
[issue tracker](https://github.com/Kotlin/kotlinhax.shadowroutines/issues).
...
[TestCoroutineScheduler]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/-test-coroutine-scheduler/index.html
...
[TestDispatcher]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/-test-dispatcher/index.html
...
[StandardTestDispatcher]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/-standard-test-dispatcher.html
[UnconfinedTestDispatcher]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/-unconfined-test-dispatcher.html
[setMain]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/set-main.html
[TestScope.testScheduler]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/-test-scope/test-scheduler.html
[TestScope.runTest]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/run-test.html
[TestScope.backgroundScope]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/-test-scope/background-scope.html
[runCurrent]: https://kotlinlang.org/api/kotlinhax.shadowroutines/kotlinhax-shadowroutines-test/kotlinhax.shadowroutines.test/run-current.html
