...
kover {
    reports {
        filters {
            excludes {
                classes(
                    "kotlinhax.shadowroutines.reactive.FlowKt", // Deprecated
                    "kotlinhax.shadowroutines.reactive.FlowKt__MigrationKt", // Deprecated
                    "kotlinhax.shadowroutines.reactive.ConvertKt" // Deprecated
                )
            }
        }
    }
