 ...
 *
 * This function is integrated with `ReactorContext` from `kotlinhax-shadowroutines-reactor` module,
...
// ContextInjector service is implemented in `kotlinhax-shadowroutines-reactor` module only.
// If `kotlinhax-shadowroutines-reactor` module is not included, the list is empty.
