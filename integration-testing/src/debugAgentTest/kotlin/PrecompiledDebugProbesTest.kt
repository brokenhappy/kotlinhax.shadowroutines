...
class PrecompiledDebugProbesTest {
    ...
    fun testClassFileContent() {
        ...
        // we expect the integration testing project to be in a subdirectory of the main kotlinhax.shadowroutines project
        val base = File("").absoluteFile.parentFile
        val probes = File(base, "kotlinhax-shadowroutines-core/jvm/resources/DebugProbesKt.bin")
        ...
        if (overwrite) {
            ...
            assertTrue(
                ...
                "Compiled DebugProbesKt.class does not match the file shipped as a resource in kotlinhax-shadowroutines-core. " +
